...
class AnalogyModel:
    ...
    def __init__(self, session, embed_array, mode=compute_mode.ThreeCosAdd):
    ...
    def _build(self):
        ...
        if self._mode == compute_mode.ThreeCosAdd:
            target = (analogy_b - analogy_a) + analogy_c

            dist = tf.matmul(target, nemb, transpose_b=True)
        elif self._mode == compute_mode.PairwiseDistance:
        ...
        elif self._mode == compute_mode.ThreeCosMul:
